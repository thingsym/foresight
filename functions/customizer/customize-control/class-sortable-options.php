...
<label><input type="checkbox" value="<?php echo esc_attr( $option ); ?>" <?php checked( in_array( $option, $this->value(), true ), 1 ); ?> class="multiple-checkbox-item"> <?php echo esc_html( $this->options[ $option ] ); ?></label>
<div class="ui-handle">
